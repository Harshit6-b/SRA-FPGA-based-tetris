module binary_loader(
    ...
    // Fixed function to get digit pixel (corrects mirroring issue)
// Fixed function to get digit pixel (only fixes vertical flip - numbers were upside down)
function get_digit_pixel;
    ...
    begin
        ...
        endcase
        // Only fix vertical flip for digits (they're upside down)
        get_digit_pixel = font_data[(6 - px_y) * 5 + (4 - px_x)];
    end
endfunction

// Letters work correctly with both flips
function get_letter_pixel;
    ...
    begin
        case (letter_id)
            ...
            default: font_data = 35'b00000_00000_00000_00000_00000_00000_00000;
        endcase
        // Both horizontal and vertical flip for letters
        get_letter_pixel = font_data[(6 - px_y) * 5 + (4 - px_x)];
    end
endfunction
